...
public class FeedDAO {
    ...
    private static Object[][] getFeedItems(String rssLink, int feedId) {
        SyndFeed feed = buildFeed(rssLink);
    ...
    private static SyndFeed buildFeed(String feedLink) {
        SyndFeedInput input = new SyndFeedInput();
        try {
            return input.build(new XmlReader(new URL(feedLink)));
        } catch (FeedException e) {
            logger.log(Level.SEVERE, "Cannot parse feed");
            throw new RuntimeException(e);
        } catch (IOException e) {
            logger.log(Level.SEVERE, "Cannot read from URL");
            throw new RuntimeException(e);
        }
    }
    ...
    public static void updateRssItemsForUser(int userId) throws SQLException, ValidationFailedException {
    ...
    private interface DbAction {
        void act(Connection conn) throws SQLException, ValidationFailedException;

        default void doAction() throws SQLException, ValidationFailedException {
